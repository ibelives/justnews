...
cropperModal = function ( data ) {
    ...
    var html = '<div class="modal member-crop-modal fade" id="crop-modal" data-backdrop="static">\n' +
        ...
        '                    <p>'+data.desc+'</p>\n' +
        '                    <div class="btn btn-primary" onclick="jQuery(\'input[id=img-file]\').click();">'+data.btn+'</div>\n' +
        '                    <input style="display: none;" type="file" id="img-file" name="img-file">\n' +
        '                </div>\n' +
        ...
        '                <div class="pull-left crop-notice"></div>\n' +
        '                <div class="btn btn-primary j-crop-apply">'+data.apply+'</div>\n' +
        '                <div class="btn" data-dismiss="modal">'+data.cancel+'</div>\n' +
        '            </div>\n' +
        '        </div>\n' +
        '    </div>\n' +
        '</div>';
